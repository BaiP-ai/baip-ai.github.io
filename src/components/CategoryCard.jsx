// Category card component for displaying AI tool categories
...
const CategoryCard = (props) => {
  ...
  const getIconPath = (iconName) => {
    ...
    return iconPaths[iconName] || iconPaths['graph'];
  };

  return (
    <a href={getSitePath(`/categories/${category.id}`)} class="card hover:scale-105 transition-transform duration-200">
      <div class="p-6">
        <div class="flex items-center mb-4">
          <div class="w-12 h-12 mr-4 flex-shrink-0 bg-blue-100 dark:bg-blue-900 rounded-md flex items-center justify-center">
        ...
        <div>
          <h4 class="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Subcategories</h4>
